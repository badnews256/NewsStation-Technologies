...
The Activity Manager is the interface for the NewsOS Audit Log.

It provides administrators with a complete chronological history of meaningful platform events.

The Activity Manager displays audit information but does not generate it.
...
The Activity Manager is the administrative interface for the NewsOS Audit Log.

It provides administrators with a complete chronological history of meaningful events performed throughout the NewsOS platform.

---

## Design Philosophy

The Activity Manager displays the NewsOS Audit Log.

It does not generate activity.

It does not own platform data.

Its responsibility is presenting a complete audit history generated by other NewsOS systems.

---

## Audit Log Philosophy

The NewsOS Audit Log is the single source of truth for platform activity.

Every meaningful action performed throughout NewsOS should create an audit entry.

The Dashboard displays a Recent Activity summary generated from the Audit Log.

The Activity Manager displays the complete audit history.

The Audit Log is shared across the platform to eliminate duplicate activity systems.

---

## Responsibilities

The Activity Manager displays events such as:
...
- Display chronological audit history
- Display administrator responsible
- Display affected module
...
Selecting Activity updates the existing Studio workspace.
...
The Activity Manager reads information from the NewsOS Audit Log.

It does not create, modify, or delete audit records.
...
- Severity levels
- Audit analytics
- Click an audit entry to open the related item in the appropriate Studio manager